...
namespace Bragi.Web.Controllers.Api.Transportation
{
    [Route("api/[controller]")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme, Policy = "Bearer")]
    public class TransportationController : ControllerBase //ReadableController<ITransportationService,TransportationMethod,TransportationMethodViewModel>
    {
