...
{
    public class SectorConfig: IEntityTypeConfiguration<Sectors>
    {
        public void Configure(EntityTypeBuilder<Sectors> builder)
        {
            ...
            builder.Property(x => x.MunicipalDistrict).HasMaxLength(40);
            builder.Property(x => x.Municipalities).HasMaxLength(40);
            builder.Property(x => x.Section).HasMaxLength(40);
